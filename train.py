...
class ModelArguments:
    ...
    tokenizer_name: Optional[str] = field(
        default="vinai/phobert-base", metadata={"help": "Pretrained tokenizer name or path if not the same as model_name"}
    )
...
def main():
    ...
    trainer = CLTrainer(
        ...
        eval_dataset=train_dataset,  # Use training data for evaluation
        tokenizer=tokenizer,
    ...
    if training_args.do_train:
        ...
        trainer.save_model("model")  # Saves the tokenizer too for easy upload
